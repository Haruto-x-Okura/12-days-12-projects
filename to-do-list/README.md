...
- Add unlimited tasks dynamically  
...
2. Clicking the **Add** button creates a new task dynamically  
3. Each task is displayed in its own box with:
   - A checkbox to mark completion
   - A delete button to remove the task  
4. Tasks are managed using JavaScript DOM manipulation  
